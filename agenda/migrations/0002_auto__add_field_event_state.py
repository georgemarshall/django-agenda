...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('agenda_event', 'state', self.gf('django.db.models.fields.CharField')(default='V', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.state'
        db.delete_column('agenda_event', 'state')
    ...
    models = {
        ...
        'agenda.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 29, 14, 43, 0, 728082)'}),
