...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('agenda_event', 'event_date', 'begin_date')

    def backwards(self, orm):
        db.rename_column('agenda_event', 'begin_date', 'event_date')
    ...
    models = {
        ...
        'agenda.event': {
            ...
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 18, 9, 49, 18, 237504)'}),
